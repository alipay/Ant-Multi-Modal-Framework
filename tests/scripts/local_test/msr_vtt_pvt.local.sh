...
CONFIG=prj/video_text_pretrain/configs/univl/video/finetune_retrieval/msr_vtt_pvt.local.yml
TEST_FINETUNE_SAVE_DIR=/YourPath/

export CUDA_VISIBLE_DEVICES=0,1
python -m antmmf.utils.launch \
    --nproc_per_node=2 --master_port=12391 prj/video_text_pretrain/run.py \
    --config ${CONFIG} \
