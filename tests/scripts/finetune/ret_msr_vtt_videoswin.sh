...
CONFIG=prj/video_text_pretrain/configs/univl/video/finetune_retrieval/msr_vtt_videoswin.yml
PRETRAINED_SAVE_DIR=/YourCheckpointPath/
MSRVTT_FINETUNE_SAVE_DIR=/YourPath/

export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
python -m antmmf.utils.launch \
    --nproc_per_node=8 --master_port=12392 prj/video_text_pretrain/run.py \
    --config ${CONFIG} \
