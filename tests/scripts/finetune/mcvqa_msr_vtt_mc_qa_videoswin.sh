...
CONFIG=prj/video_text_pretrain/configs/univl/video/finetune_multi_choice_qa/msr_vtt_mc_qa_videoswin.yml
MSRVTT_FINETUNE_SAVE_DIR=/YourCheckpointPath/
ROOT_DIR=/YourPath/

CUDA_VISIBLE_DEVICES=1 \
python -m antmmf.utils.launch --nproc_per_node=1 --master_port=12201 prj/video_text_pretrain/run.py \
  --config ${CONFIG} \
