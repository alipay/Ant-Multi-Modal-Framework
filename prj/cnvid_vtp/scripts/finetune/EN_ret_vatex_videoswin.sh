...
CONFIG=prj/cnvid_vtp/configs/univl/video/finetune_retrieval/EN_vatex_videoswin.yml
PRETRAINED_SAVE_DIR=/YourCheckpointPath/
VATEX_EN_FINETUNE_SAVE_DIR=/YourPath/
...
python -m antmmf.utils.launch \
    ...
    training_parameters.save_dir ${VATEX_EN_FINETUNE_SAVE_DIR}/test \
