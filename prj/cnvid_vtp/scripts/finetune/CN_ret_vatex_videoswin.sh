...
CONFIG=prj/cnvid_vtp/configs/univl/video/finetune_retrieval/CN_vatex_videoswin.yml
PRETRAINED_SAVE_DIR=/YourCheckpointPath/
VATEX_CN_FINETUNE_SAVE_DIR=/YourPath/
...
python -m antmmf.utils.launch \
    ...
    training_parameters.save_dir ${VATEX_CN_FINETUNE_SAVE_DIR}/test \
