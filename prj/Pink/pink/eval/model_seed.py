...
def eval_model(args):
    ...
    orignal_questions = json.load(open(args.question_file, "r"))
    questions = []
    for q in orignal_questions['questions']:
    ...
    if args.strict_answer:
        answer_list = ["The answer is A.", "The answer is B.", "The answer is C.", "The answer is D."]
    ...
    for batch_id in tqdm(range(total_items // batch_size + 1)):
        ...
        for i, line in enumerate(batch_questions):
            ...
            image_id = line['data_id']
            question = line['question']
            gt_ans = line['answer']
            answer_choices = [line['choice_a'], line['choice_b'], line['choice_c'], line['choice_d']]
            try:
            ...
            options = ""
            for index, opt in enumerate(answer_choices):
            ...
            result_dict['question_type_id'] = question_type_id
        ...
        for i in range(len(outputs)):
            ...
            if len(res) == 1:
                answer = res[0]  # 'A', 'B', ...
                if answer == result_dicts[i]['gt_answer']:
                    num_correct += 1
            else:
                answer = "FAILED"
