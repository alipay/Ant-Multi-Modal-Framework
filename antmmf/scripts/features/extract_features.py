...
# Run using
# extract_detectron_feat.py --cfg ${d_23_cfg}  --image-ext jpg  --wts ${d_23_md} \
# --output_dir ${out_dir}/test2015  --feat_name gpu_0/fc6  --min_bboxes 100 --max_bboxes 100  ${input_dir}
...
def extract_bboxes(bottom_up_csv_file):
    ...
    with open(bottom_up_csv_file, "r", encoding="utf-8") as tsv_in_file:
