...
class Logger:
    def __init__(self, config):
        ...
        # Note: log_folder is now NOT affected by config_override,
        # config_override yaml file is now ONLY allowed in Aidesk env.
        ...
        self.log_filename += "-%s" % config.training_parameters.local_rank
        ...
        if not os.path.exists(self.log_folder):
            os.makedirs(self.log_folder, exist_ok=True)  # distributed
...
class StdoutLogger(Logger):
    """
    online logger that do not make dirs and log into files.
    """
