...
is that they will process both images and boxes.
"""
...
class Normalize:
    ...
    def __call__(self, image: torch.Tensor, target=None):
        ...
        if "boxes" in target:
            boxes = target["boxes"]
            boxes = (
                Boxes(boxes, Boxes.BOX_MODE_XYXY)
                .convert_box_mode(Boxes.BOX_MODE_CXCYWH)
                .tensor
            )
