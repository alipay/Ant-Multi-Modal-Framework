...
# Code for BERT model from Chinese CLIP:
# https://github.com/OFA-Sys/Chinese-CLIP/blob/master/cn_clip/clip/modeling_bert.py
# This code has some modifications compared to the official bert code:
# https://github.com/huggingface/transformers/blob/main/src/transformers/models/bert/modeling_bert.py
# Modify:: BertEmbeddings, BertSelfAttention, BertAttention, BertLayer, BertEncoder, BertModel
# Delete: BertForPreTrainingOutput
...
class BertModel(BertPreTrainedModel):
    ...
    Outputs: `Tuple` comprising various elements depending on the configuration (config) and inputs:
        ...
        **attentions**: (`optional`, returned when ``config.output_attentions=True``)
            list of ``torch.FloatTensor``,``(batch_size, num_heads, sequence_length, sequence_length)``:
